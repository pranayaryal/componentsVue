        ...
        <div class="navline">
            <nav>
                <ul>
                    ...
                    <!--<li><a href="/blog" class="nav-list-item">Blog</a></li>-->
                    <li><vlink href="/" class="nav-list-item">Your Name</vlink></li>
                    <li><vlink href="/about" class="nav-list-item">About</vlink></li>
